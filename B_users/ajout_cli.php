                    ...
                    <div class="card col-lg-8 d-flex m-auto" style="background: #1d264aa9!important;">
                        ...
                        <div class="">
                            <div class="" >
                                ...
                                <form action="../B_config/ajouter_cli.php" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <label for="apropos"><?php echo _("A propos du client/Commentaire")?>:</label>
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-dark  mt-2 mb-lg-2 col-lg-3"><?php echo _("Ajouter client");?></button>
                                        </div>
                                </form>
                                </div>
                            </div>

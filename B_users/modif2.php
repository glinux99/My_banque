...
<div class="container-fluid">
    <div class="row flex-nowrap bg-css">
       ...
       <?php include ('../B_menu/menug_user.html');?>
         <!--fin menu gauche flotable-->
        <div class="w-100">
            <!--Menu Principale center-->
            <?php include ('../B_menu/menup_user.html');?>
            ...
            <div class="col">
                ...
                <div class="row justify-content-center text-success" >
                        ...
                        <div class="">
                            <div class="" >
                                ...
                                <form action="../B_config/modify.php" method="POST">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <select name="genre" id="" class="form-control">
                                                    ...
                                                    <?php if($query['genre']=='M'){
                                                        ...
                                                        } else echo '<option value="M">Masculin</option>';?>
                                                </select>
                                            </div>
                                            <div class="col-lg-4">
                                        ...
                                        <button type="submit" class="btn btn-dark pull-right mt-2">Mettre a jour</button>
                                </form>
                                </div>
                                <!-- <div class="list-group-item">
                                    <div class="card-header">
                                        <div class="row">
                                            ...
                                            Ajouter un mandateur
                                            </div>
                                            <div class="col-auto">
                                                <button type="button" class="btn btn-success" data-toggle="collapse" data-target="#coll" aria-expanded="false" aria-controls="coll">Ajouter <span class="icon-plus" ></span></button>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <label for="nomB" >Nom</label>
                                        <input type="text" name="mabtq" id="" class="form-control" placeholder="gVente" >
                                    </div>
                                    <div class="col-lg-4">
                                        <label for="nomB" >Prenom</label>
                                        <input type="text" name="nvendeur" id="" class="form-control" placeholder="gVenteUser22">
                                    </div>
                                    <div class="col-lg-4">
                                        <label for="nomB" >Adresse e-mail</label>
                                        <input type="mail" name="gvmail" id="" class="form-control" placeholder="gvente@gventes.com">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-4">
                                        <label for="nomB" >Matricule Client</label>
                                        <input type="text" name="mabtq" id="" class="form-control" placeholder="gVente" disabled>
                                    </div>
                                    <div class="col-lg-4">
                                        <label for="nomB" >Password</label>
                                        <input type="text" name="nvendeur" id="" class="form-control" placeholder="gVenteUser22">
                                    ...
                                    <div class="col-lg-4">
                                        <label for="nomB" >Numero Tel: </label>
                                        <input type="mail" name="gvmail" id="" class="form-control" placeholder="+243970912428">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-4">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <label for="nomB" >Adresse</label>
                                        <input type="text" name="mabtq" id="" class="form-control" placeholder="Goma, 22 Box Dego">
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <label for="nomB" >Pays</label>
                                        <input type="mail" name="gvmail" id="" class="form-control" placeholder="RDC" disabled>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <label for="apropos">A propos de moi:</label>
                                        <textarea name="" placeholder="A propos de moi" class="form-control"></textarea>
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-dark pull-right mt-2">Creer un compte</button>
                    ...
                    <div class="card col-lg-3 h-100">
                        ...
                        <div class="card-img">
                            <img src="B_img/default_user.png" alt="" id="img" class="w-100 img-thumbnail" >
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-primary" id="capture">Capturer</button>
                                            <button type="button" class="btn btn-primary" data-dismiss="modal" id="confirmer" style="display: none">Confirmer</button>
                                         </div>
                                    </div>
                                </div>
                            </div>
...
<script>
  ...
  button.addEventListener('click', () => {
    ...
    document.getElementById('href').href=imgurl;
    document.getElementById('href').download = "nom.png";
    alert(imgurl);
